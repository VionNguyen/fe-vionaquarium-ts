...
import { AndInterFace, AuthContextType, ChangeProfile, DataSign, InitStateUser, MoreUser, OrInterFace, SigninUser, UpDateUser, UserAccessToken, UserSign } from '../models/interface-auth'
 
export const ProfileUser: React.FC = () => {
  const auth: any = useAuth()
  // const productCtx: any = useProductCtx()
  ...
  const handleOnChange = (name: any) => (e: React.ChangeEvent<HTMLInputElement>) => {
    setState({
      ...state,
      [name]: e.target.value,
    })
