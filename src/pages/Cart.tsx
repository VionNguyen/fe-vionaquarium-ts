...
import { DataProduct, Item, ListProductResponse, ProductContextType } from '../models/interface-product'

export const Cart: React.FC = () => {
  const productCtx: ProductContextType = useProductCtx()
  const listItemInCart: DataProduct[] = productCtx.productInCart
